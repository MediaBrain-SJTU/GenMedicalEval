...
* **[2023.12.25]** [论文](class/UniMedicalEval1.pdf) (Arxiv版本待审核)
...
1.**从医疗考试到专业技能的全面分析**：“UniMedicalEval”专注于通过患者治疗记录的深度分析来全面评估医疗语言模型。本评测框架不限于考察语言模型在医疗考试中的表现，更进一步评估其在实际医疗环境中的专业应用能力。我们包含了病例分类、诊断过程、病史、治疗计划和患者反馈等多方面信息，以及医生笔记和诊断报告等非结构化数据，为语言模型在实际医疗场景中的性能提供了全面的评估基础。

2.**医疗伦理和安全性的综合考量**：“UniMedicalEval”在其数据集构建中也关注医疗LLMs在伦理和安全方面的表现。我们涵盖了伦理挑战、患者知情权、反事实分析和歧视检测等关键领域。这种全面的方法不仅体现了医疗领域对伦理和安全性的重视，也有助于建立对医疗语言模型的信任，确保这些系统在提升医疗服务质量的同时，能够考虑患者的权益。

3.**专业能力的精准评估指标**：“UniMedicalEval”采用了一种创新的评估方法，基于结构化回答和医学术语的对齐来评估语言模型。这种方法不仅评价了模型在医疗专业考试中的表现，也关注其在实际医疗场景中的应用效果和准确性。这使得“UniMedicalEval”能够精确地评估医疗语言模型的综合性能和实用价值。
...
###  2.1. <a name='Pipeline'></a>数据集生成Pipeline
...
[基础医疗问答](class/基础医疗问答.md)

**场景三：报告解读**

[报告诊断](class/diseasecheck.md)，[检查推荐](class/检查推荐.md)，[治疗咨询](class/治疗咨询.md)
...
[预问诊](class/预问诊.md)，[导诊](class/导诊.md)
