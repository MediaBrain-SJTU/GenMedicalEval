...
|-----------------|---------|-------------|----------|----------|----------|----------|----------|----------|----|-------|----------|------|
| GPT-4           | 0.79    | 0.72        | 0.96     | 0.94     | 0.81     | 0.56     | 0.95     |0.73| 0.68 | 0.90 | 0.76    | 0.79  |
| 文心一言         | 0.84    | 0.78        | 0.89     | 0.95     | 0.86     | 0.51     | 0.98     |0.55| 0.71 | 0.73  | 0.63   | 0.79  |
| 星火大模型       | 0.71    | 0.57        | 0.94     | 0.96     | 0.91     | 0.59     | 0.93     |0.59| 0.74 | 0.71 | 0.60    | 0.77  |
| 通义千问         | 0.69    | 0.60        | 0.95     | 0.94     | 0.72     | 0.45     | 0.91     |0.48| 0.74  | 0.57 | 0.71   | 0.72  |
| Huatuo2-13B     | 0.58    | 0.67        | 0.96     | 0.94     | 0.75     | 0.42     | 0.95     |0.42| 0.64  | 0.83 | 0.52   | 0.70  |
| MING-7b     | 0.25    | 0.22        | 0.15     | 0.18     | 0.19     | 0.50     | 0.89     |0.39| 0.41 | 0.52| 0.27     | 0.35  |
|  DoctorGLM     | 0.25    | 0.22        | 0.15     | 0.18     | 0.19     | 0.50     | 0.89     |0.39| 0.41 | 0.52| 0.27     | 0.35  |
...
###  3.2. <a name='-1'></a>生成式评测

以往的医疗基准主要依靠多选题准确率和 GPT-4 评分等指标进行评估。然而，这种方法有其局限性。
事实上，对于大语言模型来说，会做多项选择题并不意味着能回答开放式问题。此外，在实际的医学应用场景中，往往不会向医学大语言模型提供选项。
此外，医疗领域的从业人员更关注大语言模型所提供的知识，而不是句子的流畅性和完整性。因此，从知识性的角度评估医学大语言模型回答开放式医学问题的能力可以准确评估其综合表现和实用价值。

因此，为了对模型的基础知识能力、场景应用能力与安全规范能力进行全面、可靠的评估，除了常用的选择题准确率和GPT-4评分等指标以外，UniMedicalEval还设计了针对生成式大语言模型回答开放式问题的评测指标。
